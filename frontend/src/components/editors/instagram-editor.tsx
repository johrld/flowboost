...
export function InstagramEditor({ values, onChange, readOnly, projectName = "your_brand", authorName, authorImage }: InstagramEditorProps) {
  ...
  return (
    <div className="flex gap-8">
      ...
      {/* Right: Preview */}
      <div className="w-[320px] shrink-0 sticky top-0 self-start">
        <p className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-2">Instagram Preview</p>
